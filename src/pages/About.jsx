...
export default function About() {
    return(
      <div className="twelve-grid-container">
        <div className="twelve-col-full p-large-bottom">
          <h1>
        ...
        <div className="about-portrait twelve-col-first-five">
        ...
        <div className="twelve-col-last-six">
          ...
          <div className="two-columns-off p-medium-bottom">
            <div className="title">
              <p className="label">Daphne Mohajer va Pesaran (PhD)</p>
            </div>
            <p className="info">
          ...
          <div clasName="two-columns-off p-medium-bottom">
            <div className="title">
              <p className="label">
          ...
          <div>
            <p className="p-medium-bottom">
              To buy a DNJ piece, please have a look at our shop,or visit one of our stockists:
            </p>

            <p className="label">Melbourne, Australia</p>
            <ul className="p-medium-bottom">
              <li>Craft Victoria</li>
              <li>The Social Studio</li>
            </ul>

            <p className="label">Adelaide, Australia</p>
            <ul className="p-medium-bottom">
              <li>Shop Pond</li>
            </ul>
            ...
            <p className="label">Tokyo, Japan</p>
            <ul className="p-medium-bottom" >
